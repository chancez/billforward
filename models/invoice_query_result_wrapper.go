...
/*
InvoiceQueryResultWrapper invoice query result wrapper

swagger:model InvoiceQueryResultWrapper
*/
type InvoiceQueryResultWrapper struct {
...
// Validate validates this invoice query result wrapper
func (m *InvoiceQueryResultWrapper) Validate(formats strfmt.Registry) error {
	return nil
}
