...
/*MetadataKeyValuesPagedMetadata MetadataKeyValuesPagedMetadata metadata key values paged metadata

swagger:model MetadataKeyValuesPagedMetadata
*/
type MetadataKeyValuesPagedMetadata struct {
...
// Validate validates this metadata key values paged metadata
func (m *MetadataKeyValuesPagedMetadata) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MetadataKeyValuesPagedMetadata) validateCurrentOffset(formats strfmt.Registry) error {
...
func (m *MetadataKeyValuesPagedMetadata) validateCurrentPage(formats strfmt.Registry) error {
...
func (m *MetadataKeyValuesPagedMetadata) validateExecutionTime(formats strfmt.Registry) error {
...
func (m *MetadataKeyValuesPagedMetadata) validateNextPage(formats strfmt.Registry) error {
...
func (m *MetadataKeyValuesPagedMetadata) validateRecordsRequested(formats strfmt.Registry) error {
...
func (m *MetadataKeyValuesPagedMetadata) validateRecordsReturned(formats strfmt.Registry) error {
...
func (m *MetadataKeyValuesPagedMetadata) validateResults(formats strfmt.Registry) error {
