...
var stripeAuthCaptureRequestBillingEntityEnum []interface{}

func (m *StripeAuthCaptureRequest) validateBillingEntityEnum(path, location string, value string) error {
	if stripeAuthCaptureRequestBillingEntityEnum == nil {
		var res []string
