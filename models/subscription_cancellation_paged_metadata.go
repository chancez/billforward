...
/*SubscriptionCancellationPagedMetadata SubscriptionCancellationPagedMetadata subscription cancellation paged metadata
...
type SubscriptionCancellationPagedMetadata struct {
	...
	*/
	...
	Required: true
	*/
	Results []*MutableBillingEntity `json:"results,omitempty"`
}
